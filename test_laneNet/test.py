...
def load_pretrained_weights(variables, pretrained_weights_path, sess):
    ...
    pretrained_weights = np.load(
        'E:/important/BaiduNetdiskDownload/tusimpleData/weights/vgg16.npy', encoding='latin1').item()
...
def record_training_intermediate_result(gt_images, gt_binary_labels, gt_instance_labels,
                                        ...
                                        save_dir=r'E:\important\BaiduNetdiskDownload\tusimpleData\tmp'):
    """
...
model_save_path = r'E:\important\BaiduNetdiskDownload\tusimpleData\model_save'
...
tboard_save_path = 'E:/important/BaiduNetdiskDownload/tusimpleData/0601tboard/tusimple_lanenet_{:s}'.format(net_flag)
...
with sess.as_default():
    ...
    if net_flag == 'vgg' and weights_path is None:
        pretrained_weights_path = 'E:/important/BaiduNetdiskDownload/tusimpleData/weights/vgg16.npy'
